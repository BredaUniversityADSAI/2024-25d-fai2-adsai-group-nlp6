...
app = FastAPI(
    ...
    description="API for predicting emotion from text using the emotion classification pipeline.",
    version="0.1.0",
)
...
def read_root():
    ...
    return {"message": "Welcome to the Emotion Classification API! Use the /predict endpoint to analyze text."}
